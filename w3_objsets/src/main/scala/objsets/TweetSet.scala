...
abstract class TweetSet {
   ...
   */
    ...
    def mostRetweetedStep(tweet: Tweet): Tweet
...
class Empty extends TweetSet {
    ...
    def mostRetweetedStep(tweet: Tweet): Tweet = tweet
...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
    ...
    def mostRetweeted: Tweet = mostRetweetedStep(elem)
    
    def maxOfTwo(a: Tweet, b: Tweet) = if (a.retweets > b.retweets) a else b
    
    def mostRetweetedStep(tweet: Tweet): Tweet =
      left.mostRetweetedStep(right.mostRetweetedStep(maxOfTwo(elem, tweet)))
      
    def descendingByRetweet: TweetList = {
      val elem = mostRetweeted
      new Cons(elem, this.remove(elem).descendingByRetweet)
    }
